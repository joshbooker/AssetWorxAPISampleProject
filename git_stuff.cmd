...
git remote add origin https://github.com/joshbooker/AssetWorxAPISampleProject.git   // add remote repository URL which contains the required details
git pull origin master                                             // always pull from remote before pushing
git push -u origin master  
git pull origin dev                                             // always pull from remote before pushing
git push -u origin dev                                          // publish changes to your remote repository

git clone --single-branch --branch dev https://github.com/joshbooker/SequencR.git
